...
{
    [DbContext(typeof(hosamhemailyDbContext))]
    [Migration("20240503143112_nullable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hosamhemaily.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("hosamhemaily.TodoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("hosamhemaily.TodoItem", b =>
                {
                    b.OwnsOne("hosamhemaily.TodoAddress", "Address", b1 =>
                        {
                            ...
                            b1.OwnsOne("hosamhemaily.TodoCity", "CityId", b2 =>
                                {
                                    b2.Property<Guid>("TodoAddressTodoItemId")
                                        .HasColumnType("uniqueidentifier");
                                    ...
                                    b2.HasKey("TodoAddressTodoItemId");

                                    b2.ToTable("TodoItems");

                                    b2.WithOwner()
                                        .HasForeignKey("TodoAddressTodoItemId");
                                });

                            b1.Navigation("CityId")
                                .IsRequired();
                        });
